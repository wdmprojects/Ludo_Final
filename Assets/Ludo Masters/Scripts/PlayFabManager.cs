...
//            fbManager.showLoadingCanvas();
    ...
    public void Login()
    {
//		if(GameObject.Find("mydemotext"))
//		{
//			GameObject.Find("mydemotext").GetComponent<Text>().text = "playfab login call";
//		}
        string customId = "";
...
//		if(GameObject.Find("mydemotext"))
//		{
//			GameObject.Find("mydemotext").GetComponent<Text>().text = "UNIQUE IDENTIFIER: " + customId;
//		}
...
//				if(GameObject.Find("mydemotext"))
//				{
//					GameObject.Find("mydemotext").GetComponent<Text>().text = "Got PlayFabID: " + PlayFabId;
//				}
            Dictionary<string, string> data = new Dictionary<string, string>();
...
//				if(GameObject.Find("mydemotext"))
//				{
//					GameObject.Find("mydemotext").GetComponent<Text>().text = "Error logging in player with custom ID:";
//				}
