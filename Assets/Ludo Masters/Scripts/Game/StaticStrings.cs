namespace AssemblyCSharp
{
    public static class StaticStrings
    {
        ...
        public static string AndroidPackageName = "com.ludo.star";
        public static string ITunesAppID = "11111111111";



        // Notifications
        public static string notificationTitle = "Ludo Star";
		...
		public static string PlayFabTitleID = "64BA";
		public static string PhotonAppID = "0a16eb70-9a43-4337-85d4-8db24c75718a";
		public static string PhotonChatID = "0a16eb70-9a43-4337-85d4-8db24c75718a";
        ...
        public static string facebookShareLinkTitle = "I'm playing Ludo Star!. Available on Android and iOS.";

        // Share private room code
        public static string SharePrivateLinkMessage = "Join me in Ludo Star. My PRIVATE ROOM CODE is:";
		public static string SharePrivateLinkMessage2 = "Download Ludo Star from:";
		public static string ShareScreenShotText = "I finished game in Ludo Star. It's my score :-) Join me and download Ludo Masters:";
